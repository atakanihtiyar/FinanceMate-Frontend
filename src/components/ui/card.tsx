...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "tw-rounded-2xl tw-border tw-border-[var(--card-border)] tw-bg-[var(--card)] tw-text-[var(--card-foreground)] tw-shadow",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("tw-text-sm tw-text-[var(--muted)] dark:tw-text-zinc-400", className)}
    {...props}
  />
))

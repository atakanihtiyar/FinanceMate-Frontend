...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "tw-inline-flex tw-h-9 tw-items-center tw-justify-center tw-rounded-lg tw-bg-zinc-100 tw-p-1 tw-text-zinc-500 dark:tw-bg-zinc-800 dark:tw-text-zinc-400",
      className
    )}
    {...props}
  />
